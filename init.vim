...
let g:coc_global_extensions = ['coc-explorer', 'coc-json', 'coc-pyright', 'coc-tsserver', 'coc-import-cost', 'coc-eslint', 'coc-snippets', 'coc-html', 'coc-css', 'coc-emmet', 'coc-phpls', 'coc-angular', 'coc-git']
